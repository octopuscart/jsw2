...
<html lang="en">
    <head>
        <title> Email Template - Newsletter</title>
                            ...
                            <tr>
                                <td class="wrapper">
                                    ...
                                    <table class="six columns">
                                        <tr>
                                            <td>
                                                <a href="https://jswelectronics.com"><img src="https://jswelectronics.com/assets/images/logo.png" height="20px" /></a>
                                            </td>
                                    ...
                                    <table class="six columns">
                                        <tr>
                                            <td class="text-right valign-middle">
                                                <a href="https://www.instagram.com/jswelectronics/">Instagram</a>
                                                <a href="https://www.facebook.com/jswelectronics">Facebook</a>
                                            </td>
                                            <td class="expander"></td>
                                        </tr>
                                    </table>
...
Thank you for your enquiry</h4>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <a href="index.html"><img src="https://jswelectronics.com/assets/homeblock/h22.jpg" /></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                            ...
                            <table class="row" style="background:white;">
                              <tr>
                                    <td class="wrapper">
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <th colspan="2" style='color:black!important; '>Product</th>
                                            ...
                                            foreach ($cartdata["products"] as $key => $value) {
                                                ...
                                                <tr style="border-top:1px solid #000">
                                                    <td style="padding-bottom: 0;"><img src="<?php echo $value['file_name']; ?>" style="height: 70px;width:70px;"/></td>
                                                    <td style="padding-bottom: 0;font-size: 15px;  color:black!important;  line-height: 30px;"><?php echo $value['title']; ?><br/><?php echo $value['short_description']; ?></td>
                                                    <td style="padding-bottom: 0;font-size: 15px;  color:black!important;  line-height: 76px;"><?php echo $value['quantity']; ?></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="btn" align="center">
                                                        <tr>
                                                            <td>
                                                                <a href="https://jswelectronics.com/">View Details!</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tr>
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    <h4 style="color:black!important">Other Products</h4>
                                                    <p>
                                                    </p>
                                                </td>
                                            </tr>
                                        ...
                                        <table class="four columns">
                                            <tr>
                                                <td>
                                                    ...
                                                    <h5 style="    color: black!important;">Full HD 1080p Andoird Smart TV</h5>
                                        ...
                                        <table class="four columns">
                                            <tr>
                                                <td>
                                                    ...
                                                    <h5 style="    color: black!important;">JSW Microwave Oven With 20 Liter Capacity</h5>
                                                    <table class="btn orange">
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:;">View Details!</a>
                                        ...
                                        <table class="four columns">
                                            <tr>
                                                <td>
                                                    ...
                                                    <h5 style="    color: black!important;">HI FI Audio System With FM Radio & 2 Speakers</h5>
                                                    <table class="btn orange">
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:;">View Details!</a>
